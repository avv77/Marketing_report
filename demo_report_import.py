...
from settings_import import path_produst
from PyPDF2 import PdfReader, PdfWriter


def tnved_number2(path_produst):
    wb = load_workbook(path_produst)
    sheet = wb['tnved']
...
for i in range(129, 592):
    ...
    file_report_pattern = r'D:\PyCharmProject\Marketing_report\doc\import_demo\Отчет_импорт_демо.docx'

    doc = DocxTemplate(file_report_pattern)

    doc.render(context)
    file_report_pattern_final = r'D:\PyCharmProject\Marketing_report\doc\import_demo\Отчет_импорт_демо_финал.docx'
